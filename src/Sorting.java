...
public class Sorting {
	...
	public static void main(String[] args) {
		...
		int[] lista = rand.list();
		int[] lista2 = rand.list();
		int[] lista3 = rand.list();
		int[] lista4 = rand.list();
		...
		int[] SelectionSort = funciones.SelectionSort(lista);
		int[] MergeSort = funciones.MergeSort(lista2);
		funciones.QuickSort(lista3);
		int[] RadixSort = funciones.RadixSort(lista4);
